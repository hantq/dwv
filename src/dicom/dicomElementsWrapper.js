...
dwv.dicom.DicomElementsWrapper = function(dicomElements) {
  ...
  this.dumpToTable = function() {
    ...
    for (var i = 0, leni = keys.length; i < leni; ++i) {
      ...
      dictElement = null;
      if (
        typeof dict[dicomElement.tag.group] !== 'undefined' &&
 ...
 * @param {String} groupElementKey The key to retrieve.
 */
dwv.dicom.DicomElementsWrapper.prototype.getElementValueAsStringFromKey = function(
  groupElementKey
) {
...
dwv.dicom.DicomElementsWrapper.prototype.getFromGroupElement = function(
  ...
  return this.getFromKey(dwv.dicom.getGroupElementKey(group, element));
};
