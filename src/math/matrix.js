...
dwv.math.Matrix33.prototype.equals = function(rhs) {
  return (
    ...
    this.get(0, 2) === rhs.get(0, 2) &&
    this.get(1, 0) === rhs.get(1, 0) &&
    this.get(1, 1) === rhs.get(1, 1) &&
    this.get(1, 2) === rhs.get(1, 2) &&
    this.get(2, 0) === rhs.get(2, 0) &&
    this.get(2, 1) === rhs.get(2, 1) &&
...
dwv.math.Matrix33.multiplyVector3D = function(vector3D) {
  ...
  var m02 = this.get(0, 2);
  var m10 = this.get(1, 0);
  var m11 = this.get(1, 1);
  var m12 = this.get(1, 2);
  var m20 = this.get(2, 0);
  var m21 = this.get(2, 1);
  var m22 = this.get(2, 2);
  // cache vector values
