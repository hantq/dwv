      ...
      2: [
        function(require, module, exports) {
          ...
          jpeg.lossless.DataStream.prototype.get16 = function() {
            var value =
              (this.buffer[this.index] << 8) + this.buffer[this.index + 1];
            this.index += 2;
            return value;
          };
          ...
          jpeg.lossless.Decoder.prototype.decode = function(
            ...
            do {
              ...
              for (i = 0; i < this.numComp; i += 1) {
                ...
                this.qTab[i] = this.quantTables[
                  this.components[compN].quantTableSel
                ];
                this.nBlock[i] =
              ...
              while (true) {
                ...
                if (this.restartInterval === 0) {
                  ...
                  while (
                    current === 0 &&
                    (this.xLoc < this.xDim && this.yLoc < this.yDim)
                  ) {
                    this.output(pred);
                    current = this.decodeUnit(pred, temp, index);
                  }
        ...
        function(require, module, exports) {
          ...
          jpeg.lossless.Utils.crc32 = function(dataView) {
            ...
            var crcTable =
              ...
              (jpeg.lossless.Utils.crcTable = jpeg.lossless.Utils.makeCRCTable());
            var crc = 0 ^ -1;
